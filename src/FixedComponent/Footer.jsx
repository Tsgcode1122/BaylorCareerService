  ...
  return (
    <>
      <Container>
        <Content>
          <First>
            <h1>University Career Services - Sid Rich, West Wing</h1>
            <p>
              Baylor Science Building, Room E128 - Garland School of Social
              Work, Room 130 | Rogers, Suite 311
            </p>
            <p>Sid Rich, West Wing </p>
            <p>Phone: 254-710-3771</p>
            <h3>On Campus Student Employment</h3>
          </First>
          <div>
            <Link to="/">
          ...
          <Bigger>
            <Big>
              <div>
                ...
                <Split>
                  <Split1>
                    ...
                    <Link to="/work-in-progress"> Career Closet</Link>
              ...
              <Socials>
                ...
                <Mail>
                  <ContactText href="mailto:careercenter@baylor.edu">
                    <FaEnvelope />
                    careercenter@baylor.edu
                  </ContactText>
                  <ContactText href="tel:254-710-3771">
                    <FaPhone />
                    254-710-3771
                  </ContactText>
                </Mail>
          ...
          <End>
            © 2024 Baylor University Career Service - All rights reserved
            <p> Designed by Falola Tosin Solomon</p>
          </End>
        </Content>
      </Container>
    </>
