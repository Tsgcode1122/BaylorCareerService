      ...
      <Container>
        ...
        <Content>
          <Focus>
            ...
            <p>
              With Focus2Career, explore and compare Majors with these career
              planning resources.
            </p>
            <QuickLink to="/login">
          ...
          <VideoInstructions to="work-in-progress">
          ...
          <Focus>
            ...
            <QuickLink
              to="https://baylor.joinhandshake.com/login"
              target="_blank"
            >
...
`;
const VideoInstructions = styled(Link)`
  position: relative;
  border-radius: 8px;
